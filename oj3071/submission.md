...
```text
ตั้งแต่ A-B มีตัวไหนบ้างที่ หาร dแล้วได้เศษ r
...
output:
จำนวนตัวที่หาร dแล้วเหลือเศษ r
...
L = []
ในขณะที่ C <=B:
    ถ้า C % d แล้วเหลือเศษเท่ากับ r
    ให้เพิ่ม C%d เข้าไปใน list
    C เพิ่ม 1 เข้าไป ให้มันวนตั้งแต่ A ถึง B
print จำนวนของใน list
```
...
```text
เหมือนแผนแรก ผมใช้ modulo เพื่อดูว่ามัน ได้เศษ r ไหม
```
