...
```text
โจทย์ให้รับค่าคะแนนรวม และ คะแนนสูงสุด และดูว่าคะแนนต่ำสุดกับสูงสุดห่างกันเกิน 2 หรือไม่ถ้าเกิน ให้บอกว่าเป็น Surprising  else: No Surprising 
...
Output:
คะแนนต่ำสุดกับสูงสุดห่างกันเกิน 2 หรือไม่ถ้าเกิน ให้บอกว่าเป็น Surprising  else: Not Surprising 

Constraints:
ถ้าคะแนนต่ำสุด < 0 ให้เท่ากับ 0
```
...
```text
Step1: รับคะแนนรวม
Step2: รับคะแนนสูงสุด
Step3: เอาคะแนนรวม - คะแนนสูงสุด*2 = คะแนนน้อยสุด
Step4: เอาคะแนนสูงสุด - ต่ำสุด = ระยะห่าง
Step5: ตรวจว่า ระยะห่างมากกว่า 2 ไหม
Step6: ถ้าจริง พิมพ์ "Surprising"
Step7: ถ้าไม่จริงพิมพ์ "Not Surprising"
```
...
```text
คล้ายๆแผนแรกแต่ถ้าคะแนนน้อยสุด < 0 ให้เท่ากับศูนย์ เพราะค่าน้อยสุดติดลบมันเป็นไปไม่ได้
```
