...
```text
input:
ความเร็ว และ จำนวนพิกัดของคน
พิกัด N พิกัด

output:
เวลาที่น้ำหมึกจะไปถึงที่พิกัด N
...
```text
รับ input ความเร็ว,จำนวนคำร้อง
loop ตามจำนวนคำร้องรับพิกัด x,y เพิ่มเข้าใน list
แล้วก็ loop ตามพิกัดใน list และหาเวลาโดย
เอา Pi*(x**2+y**2) / ความเร็ว  # x**2+y**2 คือพีทาโกรัสหาระยะห่างจาก 0,0 แล้วคูณ Pi คือหาว่ามีพื้นที่วงกลมเท่าไร แล้วเอาไปหารความเร็ว จะได้เวลาแล้วพิมพ์เวลาที่ปัดขึ้น
```
...
```text
เหมือนแผนแรก ผมใช้ while loop เพื่อรับ input และใช้ for loop เพื่อหาเวลา
```
