...
```text
รับ input เป็นจำนวนเต็ม output เป็นฤดู เงื่อนไขคือถ้าเป็นเดือนที่หารด้วยสามลงตัวและวันคือมากกว่าหรือเท่ากับ 21 จะให้ output เป็นฤดูของเดือนหน้า เช่นถ้าเป็นเดือนสามวันที่ 21 ก็จะเป็น ฤดู spring
```
...
```text
เขียน if elif สร้างเงื่อนไขของแต่ละเดือน เช่น
if month in [1,2]:
จะเป็น winter
.
.เขียนของแต่ละเดือนที่หารสามไม่ลงตัวก่อน
.
elif month ==  3 and date <21:  #แล้วเขียนของที่หารสามลงตัวในแต่ละเงื่อนไข
จะเป็น winter
แต่ถ้่า date >=21 จะให้เป็น spring ก็คือคิดเงื่อนไขแยกเอา
```
...
```text
เหมือนแผนแรก เพราะผมทำแบบตอนแรกก็ผ่านแล้ว
```
...
```text
เพราะเป็นเดือน 1 และวัน 21 เผื่อเช็คว่าเป็นวัน 21 แล้วมันจะเปลี่ยนฤดูไหม
```
...
```text
เพราะเป็นเดือนที่หารสามลงตัวแต่วันน้อยกว่า 21
```
...
```text
เพราะเป็นเดือนที่หารสามลงตัวและวันมากกว่าเท่ากับ 21
```
