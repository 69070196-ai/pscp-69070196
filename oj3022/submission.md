...
```text
 input = รับค่าจำนวนจริง หน่วยอุณหภูมิที่ป้อน หน่วยอุณหภูมิที่ต้องการเปลี่ยน
 output = ค่าอุณหภูมิที่แปลงแล้ว
 constraints = ถ้า testcase ให้แปลงเป็นหน่วยเดิมให้คิดเงื่อนไขนั้นด้วย
```
...
```text
Step 1:A = รับค่าอุณหภูมิ
Step 2:B = รับหน่วยของอุณหภูมิ
Step 3:C = รับหน่วยที่จะแปลง
Step 4:เช็ค B ว่าเป็นหน่วยอะไรและแปลงเป็น C หน่วยที่ต้องการจะเปลี่ยน
```
...
```text
คล้ายๆเดิม แต่ดูว่า เป็นอุณหภูมิหน่วยอะไร แล้วแปลงเป็น องศาC ก่อน แล้วค่อยแปลงเป็นหน่วยที่จะเปลี่ยนเพื่อกัน Too many branches
```
