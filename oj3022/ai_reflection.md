...
| OJ submission ID, if submitted | 559900 |
| OJ status | Pass |
...
```text
ว่าทำไมมันติด too many brances และ ทำไมมันยังไม่ผ่านบาง Testcase
```
...
```text
ช่วยให้สังเกตว่าถ้าให้เปลี่ยนเป็นหน่วยเดิมต้องทำเงื่อนไขนั้นไวด้วย แล้วก็แก้ too many branches ได้ด้วยการเปลี่ยนเป็น C ก่อนแล้วค่อยดูว่าเขาให้เปลี่ยนเป็นหน่วยอะไร
```
...
```text
ผมแค่เอาแนวคิดมาใช้ แต่ทดสอบโค้ดด้วยตัวเอง
```
...
```text
ทำให้ผมรู้ว่าผมต้องสังเกตหรือคิดให้รอบคอบในบางสิ่งที่โจทย์ไม่ได้บอกแต่มันเป็นสิ่งที่ต้องรู้อยู่แล้ว
```
