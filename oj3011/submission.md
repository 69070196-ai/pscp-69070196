...
```text
ให้รับค่าของสีของแม่สีเข้ามาแล้ว ถ้าไม่ใช่ให้ขึ้น Error
```
...
```text
Step 1:รับค่าสีเข้ามาสองค่า
Step 2:เช็คว่าอยู่ในแม่สีไหม ถ้าไม่ใช่ print Error
Step 3:ถ้าใช่ให้เอาไปผสมสี ค่าตัวแรกกับตัวสองสลับกันได้
```
...
```text
คล้ายๆเดิมแต่ผมลืมดูว่าถ้า มันให้สีเดียวกันมามันต้องได้สีเดิมไม่ใช่ Error เช่น Red Red ได้ Red
```
