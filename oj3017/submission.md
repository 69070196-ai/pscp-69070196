...
```text
input เป็นค่าอาหาร outputเป็นราคาที่คิด service charge+vat แล้ว service charge ต้องไม่น้อยกว่า 50 และไม่เกิน 1000 vatคิดจาก
ค่าอาหาร + service charge แล้ว
```
...
```text
Step 1:รับค่าหารแปลงเป็น int
Step 2:คิดค่า service charge
Step 3:ถ้า service < 50 ให้ = 50
Step 4:ถ้า service > 1000 ให้ = 1000
Step 5:คิดราคาที่บวกค่าบริการ
Step 6:หา vat
Step 7:ราคารวม =เอาราคา +vat
Step 8:แสดงค่ารวม ทศนิยม2ตำแหน่ง
```
...
```text
เพราะ service มากกว่า 50น้อยกว่า 1000
```
