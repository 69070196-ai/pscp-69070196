...
```text
ให้รับ input N ให้หาว่าตั้งแต่ N-0 มีตัวไหนที่หาร 10 ลงตัวบ้าง
```
...
```text
ให้รับค่า N มาเป็นจำนวนเต็มบวก ให้ a= N และสร้าง Listว่าง L 
ใช้ while a>= 0 ถ้า a%10 == 0 หรือ not a%10
ให้ L.append(a) #เพิ่ม a เข้าไปใน List
และเอา a -= 1 
และพิมพ์ *L, sep=" " # สัญลักษณ์ * คือการ unpack list และ sep คือ seperate เป็นตัวบอกว่าเราจะแยก list ด้วยอะไร
```
