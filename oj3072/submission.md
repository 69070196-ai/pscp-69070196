...
```text
รับ input และนำมาทำเป็นตัวเล็กเพราะเป็น case not sensitive 
และแยกแต่ละตัวเก็บใน list 
แล้วก็เช็คว่ามีสระตัวๆนั้นอยู่ใน List ไหมแล้วถ้ามีให้ print จำนวนสระตัวนั้นที่อยู่ใน list
```
